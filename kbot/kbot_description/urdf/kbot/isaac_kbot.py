...
prims.create_prim(
    GEN3_STAGE_PATH,
    "Xform",
    position=np.array([0, -1.0, 0]), # position=np.array([0, -0.64, 0]),
    ...
    og.Controller.edit(
        {"graph_path": "/ActionGraph", "evaluator_name": "execution"},
        {
            ...
            og.Controller.Keys.SET_VALUES: [
                ...
                # Setting the /Gen3 target prim to Articulation Controller node
                ("ArticulationController.inputs:usePath", True),
                ("ArticulationController.inputs:robotPath", GEN3_STAGE_PATH),
...
# Setting the /Gen3 target prim to Publish JointState node
set_target_prims(
    primPath="/ActionGraph/PublishJointState", targetPrimPaths=[GEN3_STAGE_PATH]
)
